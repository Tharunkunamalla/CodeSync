    ...
    <div className="mainWrap">
            ...
            <div className="aboutScrollArea">
              <div className="aboutContent">
                ...
                <p className="aboutDesc">
                  A real-time collaborative code editor designed for pair
                  programming and technical interviews. Experience seamless
                  synchronization with high-performance execution.
                </p>
                  ...
                  <ul className="rulesList">
                    <li className="ruleItem">
                      ...
                      <div className="ruleText">
                        <strong>Simultaneous Editing:</strong> Multiple users
                        can type at once. Remote cursors show you exactly where
                        others are working.
                      </div>
                    </li>
                    <li className="ruleItem">
                      ...
                      <div className="ruleText">
                        <strong>Run Protection:</strong> If a collaborator is
                        typing, the "Run Code" button will be locked for others
                        to prevent executing incomplete logic.
                      </div>
                    </li>
                    <li className="ruleItem">
                      <div className="ruleIcon">🖱️</div>
                      <div className="ruleText">
                        <strong>Activate Run:</strong> To unlock the "Run Code"
                        button while someone is typing, you must{" "}
                        <strong>click anywhere inside the editor</strong> to
                        confirm you are focused on the current state.
                      </div>
                    </li>
                    <li className="ruleItem">
                      <div className="ruleIcon">🚀</div>
                      <div className="ruleText">
                        <strong>Instant Broadcast:</strong> Language changes and
                        code updates are broadcasted to all room participants
                        immediately.
                      </div>
                    </li>
                  </ul>
      ...
      <div className="editorWrap">
        ...
        <div
          ...
          style={{width: outputWidth, overflow: "hidden"}}
        >
          <Output
